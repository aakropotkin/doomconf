;;; themes/oxcarbon-theme.el -*- lexical-binding: t; -*-
...
(defgroup oxcarbon-dark-theme nil
  "Options for the oxcarbon-dark theme."
  :group 'doom-themes)

;(defcustom oxcarbon-dark-padded-modeline doom-themes-padded-modeline
;  "If non-nil, adds a 4px padding to the mode-line.
;Can be an integer to determine the exact padding."
;  :group 'oxcarbon-dark-theme
;  :type '(choice integer boolean))

;(defcustom oxcarbon-dark-blue-modeline nil
...
(def-doom-theme oxcarbon-dark
  "Expropriated from github:shaunsingh."
  ...
  ((bg         '("#191919" "#191919" nil))
   ...
   ;; custom categories
   (modeline-bg     (if oxcarbon-dark-blue-modeline base8 bottomline-blue))
   (modeline-bg-alt (doom-darken bg 0.01))
   (modeline-fg     base8)
   (modeline-fg-alt blue)

   (-modeline-pad
    (when oxcarbon-dark-padded-modeline
      (if (integerp oxcarbon-dark-padded-modeline) oxcarbon-dark-padded-modeline 4))))
  ...
  (((highlight &override) :foreground base8)
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if oxcarbon-dark-blue-modeline base8 bottomline-blue))
